...
//        chain.doFilter(request, response);
        try {
            ...
            if (uri.contains(".gif") || uri.contains(".png")) {
                ...
                if (uri.contains("index.html") || uri.contains("index.jsp")
                        || uri.contains("DispatchServlet")
                ...
                if (session == null || session.getAttribute("LOGIN_USER") == null) {
                    ...
                    if (roleID.contains(AD) && ADMIN.contains(resource)) {
                        chain.doFilter(request, response);
                    } else if (GUEST.equals(roleID) && GUEST.contains(resource)) {
                        chain.doFilter(request, response);
                    } else {
                        res.sendRedirect(LOGIN);
                    }
